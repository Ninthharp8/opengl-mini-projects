// triangulo que respira solo con shader
...
int main()
{
    ...
    GLfloat vertices[] = {
        ...
        -0.5f, -0.5f * float(sqrt(3)) / 3, 0.0f,     0.0f, 0.0f, // Esquina inferior izquierda
         0.5f, -0.5f * float(sqrt(3)) / 3, 0.0f,     1.0f, 0.0f, // Esquina inferior derecha
         0.5f,  0.5f * float(sqrt(3)) / 3, 0.0f,     1.0f, 1.0f  // Esquina superior
    };
